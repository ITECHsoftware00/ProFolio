...
export default function ProjectCard({ title, description, tags, image, link, index }: ProjectCardProps) {
  return (
    <motion.div
      ...
      className="group relative grid md:grid-cols-[1.5fr_1fr] gap-8 items-center p-6 rounded-3xl border border-border/50 bg-secondary/10 hover:bg-secondary/20 transition-colors duration-500"
    >
      {/* Image Section */}
